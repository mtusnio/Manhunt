...
// Modified for Manhunt to allow enabling the script only for certain players

private ["_allowRejoin","_allowJIP","_timeToJIP","_allowJip", "_sentArray", "_init"];
